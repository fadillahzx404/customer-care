            ...
            <div class="title-table grid">
                <div class="flex justify-between">
                    <div class="grid place-content-center">
                        <p class="text-lg font-bold">Support User</p>
                        <p class="text-sm font-light text-gray-400">Ticket Support User on here, you available to Added,
                            edited or
                            deleted.
                        </p>
                    </div>

                    <a href="{{ route('support-user.create') }}"
                            ...
                            <td class="p-4 text-end">
                                ...
                                <div class="dropdown dropdown-end ">
                                    ...
                                    <ul tabindex="0"
                                        ...
                                        <li><a href="{{ route('support-user.show', $data->id) }}"
                                                class="hover:bg-blue-400 hover:text-white"><span><i
                                                        class="fa-solid fa-eye"></i> View</a></li>

                                        <li>
                                            <form action="{{ route('support-user.destroy', $data->id) }}"
