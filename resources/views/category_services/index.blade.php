            ...
            <div class="title-table grid">
                <div class="flex justify-between">
                    <div class="grid place-content-center">
                        <p class="text-lg font-bold">Categories Services</p>
                        <p class="text-sm font-light text-gray-400">Categories Services on here, you available to added, edited or
                            deleted.
                        </p>
                    </div>
                            ...
                            <td class="p-4 text-end">
                                ...
                                <div class="dropdown dropdown-end ">
                                    ...
                                    <ul tabindex="0"
                                        ...
                                        <li class=""><a href="{{ route('category-services.edit', $data->id) }}"
                                                class="hover:bg-orange-400 hover:text-white"><span><i
                                                        class="fa-solid fa-pen-to-square"></i> Edit</a></li>

                                        <li>
                                            <form action="{{ route('category-services.destroy', $data->id) }}"
