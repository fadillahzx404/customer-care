        ...
        <section class="user-created card card-compact bg-white shadow-xl rounded-md">
            <div class="card-body">
                <div class="grid title gap-2">
                    <p class="text-lg font-medium">Tambah Kategori Servis</p>
                    <hr class="mb-3 border-gray-300" />
                </div>
                <form action="{{ route('category-services.update', $data->id) }}" method="POST" class="grid gap-3"
                    ...
                    <div class="form-control">
                        <label class="label">
                            <span class="label-text">Nama Kategori Servis</span>
                        </label>
                        <input type="text" name="name_services" value="{{ $data->name_services }}"
